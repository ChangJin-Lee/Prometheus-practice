...
install -m 0644 /vagrant/project2/configs/prometheus/prometheus.service /etc/systemd/system/
install -m 0644 -D /vagrant/project2/configs/prometheus/prometheus.yml /etc/prometheus/prometheus.yml
