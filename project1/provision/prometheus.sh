...
install -m 0644 /vagrant/project1/configs/prometheus/prometheus.service /etc/systemd/system/
install -m 0644 -D /vagrant/project1/configs/prometheus/prometheus.yml /etc/prometheus/prometheus.yml
install -m 0644 -D /vagrant/project1/configs/prometheus/first_rules.yml /etc/prometheus/first_rules.yml
